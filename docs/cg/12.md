...
**逆运动学**(inverse kinematics)中，动画师和计算机的工作正好相反：
...
$$
\left.\frac{d}{dt}\left(\begin{array}{c}\mathrm{X}\\\theta\\\mathrm{\dot{X}}\\\omega\end{array}\right.\right)=\begin{pmatrix}\mathrm{\dot{X}}\\\omega\\\mathrm{F}/M\\\Gamma/I\end{pmatrix}
$$
